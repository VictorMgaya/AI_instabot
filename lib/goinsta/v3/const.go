...
const (
	...
	// header values
	bloksVerID         = "7189b949425f9bf80ea8bd880cf5a3080b292d9b1c4b38a18d112f7c4b71e7a8"
	fbAnalytics        = "567067343352427"
	igCapabilities     = "3brTv10="
	connType           = "WIFI"
	...
	supportedSdkVersions = "119.0,120.0,121.0,122.0,123.0,124.0,125.0,126.0,127.0,128.0,129.0,130.0,131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0"
	...
	// Other
	software = "husky-user+14+OPR1.170623.032+V10.2.3.0.OAGMIXM+release-keys"
	hmacKey  = "iN4$aGr0m"
)
